<template>
  <v-navigation-drawer v-model="isDrawerOpen">
    <v-list>
      ...
      <v-list-item link to="" prepend-icon="mdi mdi-order-bool-descending-variant" v-show="permissao !== 'default'" title="Chamados"></v-list-item>
      ...
      <v-list-group value="Configuracoes">
        ...
        <v-list-item link to="" prepend-icon="mdi-account-circle" title="Usuários"></v-list-item>
